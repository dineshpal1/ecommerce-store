				...
				<div class="col-sm-8">
					<div class="total_area">
						<ul>
							...
							<a class="btn btn-default update" href="">Update</a><br/><br>
							<?php  $customer_id=Session::get("customer_id"); ?>
							  <?php if($customer_id != NULL) { ?>
         <li><a href="{{URL::to('/checkout')}}"><i class="btn btn-success ">Checkout</i> </a></li>
                                      <?php }else{?>

                                <li><a href="{{URL::to('/login-check')}}"><i class="btn btn-info ">Checkout</i> </a></li>
                            <?php }?>
